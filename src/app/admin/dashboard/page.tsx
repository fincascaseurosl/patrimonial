    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <span className="font-semibold text-gray-900 text-sm">Admin · Patrimonial Obras</span>
          <LogoutButton />
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">{projects.length} proyecto{projects.length !== 1 ? "s" : ""}</p>
          </div>
          <Link
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <span className="text-xs text-gray-400">{project.images.length} foto{project.images.length !== 1 ? "s" : ""}</span>
                  </div>
                </div>
